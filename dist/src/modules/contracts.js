...
var Contracts = /** @class */ (function () {
    ...
    Contracts.prototype.create = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.client.contracts.create(options.node_id, options.hash, options.data, options.public_ip)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Contracts.prototype.get = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.connect()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.client.contracts.get(options.id)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Contracts.prototype.update = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.connect()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.client.contracts.update(options.id, options.data, options.hash)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Contracts.prototype.cancel = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.connect()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.client.contracts.cancel(options.id)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
